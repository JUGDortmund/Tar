...
public class ContextListenerTest {
  ...
  public void preloadData() {
    ...
    when(event.getApplicationContext().getBean(VacationRepository.class))
        .thenReturn(vacationRepository);
    when(event.getApplicationContext().getBean(ProtocolItemRepository.class))
        .thenReturn(protocolItemRepository);
    when(event.getApplicationContext().getBean(CommentItemRepository.class))
        .thenReturn(commentItemRepository);
    when(event.getApplicationContext().getBean(StateItemRepository.class))
        .thenReturn(stateItemRepository);
    when(event.getApplicationContext().getBean(UserVacationAccountRepository.class)).thenReturn(
